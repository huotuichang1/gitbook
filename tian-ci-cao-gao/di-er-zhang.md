...
```
        ...
        分析一下代码全过程：下面是定位过程的主要算法。初始化的重点在scanning-inti-scans中，后面的process则是主要过程。

{% code-tabs %}
{% code-tabs-item title="ssl.c" %}
```c
    ...
    int mod_ssl_process(mod_ssl_obj * obj) {
        ...
        if (msg_spectra_isZero(obj->in) == 0) {
            ...
            for (iPot = 0; iPot < obj->nPots; iPot++) {
                ...
                //printf("obj->pots->array[iPot * 4 + 0]%f\n,obj->pots->array[iPot * 4 + 1]%f\n,obj->pots->array[iPot * 4 + 2]%f\n,obj->pots->array[iPot * 4 + 3]%f\n",obj->pots->array[iPot * 4 + 0],obj->pots->array[iPot * 4 + 1],obj->pots->array[iPot * 4 + 2],obj->pots->array[iPot * 4 + 3]);
            }
